...
#[cfg(feature = "cipher")]
use cipher::{StreamClosure, consts::U64, StreamBackend, BlockSizeUser, ParBlocksSizeUser};
...
pub(crate) trait Rand {
    ...
    pub(crate) fn rng_inner(&mut self, mut dest_ptr: *mut u8, num_blocks: usize) {
